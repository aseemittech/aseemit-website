locals {
  ...
  backup                 = join(local.delimiter, [var.project_prefix, local.short_region[var.aws_region], var.app_name_short, local.short_env_type[var.environment], local.short_aws_services.backup])
