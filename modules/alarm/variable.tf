...
################################################################################
# Variables for CloudWatch Matric Alarm
################################################################################
...
variable "comparison_operator" {
  ...
  type        = string
  validation {
    condition     = contains(["GreaterThanOrEqualToThreshold", "LessThanOrEqualToThreshold", "LessThanThreshold", "GreaterThanThreshold"], var.comparison_operator)
    error_message = "The comparison_operator value must be valid. Either of the following is supported: GreaterThanOrEqualToThreshold, GreaterThanThreshold, LessThanThreshold, LessThanOrEqualToThreshold"
  }
}
