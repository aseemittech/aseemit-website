...
resource "aws_s3_bucket" "replication_bucket" {
  ...
  # checkov:skip=CKV_AWS_18:False Positive. This bucket is the replication destination
  # checkov:skip=CKV_AWS_144:False Positive. This bucket is the replication destination
  # checkov:skip=CKV_AWS_145:False Positive. This bucket is the replication destination
  # checkov:skip=CKV2_AWS_62:False Positive. This bucket is the replication destination
  # checkov:skip=CKV2_AWS_61:False Positive. This bucket is the replication destination
  # checkov:skip=CKV2_AWS_6:False Positive. This bucket is the replication destination
  # checkov:skip=CKV_AWS_21:False Positive. This bucket is the replication destination
  bucket = format("%s-%s-%s-%s", var.namespace, var.environment, var.name, var.bucket_replication_name)
...
resource "aws_s3_bucket_logging" "replica_bucket" {
  count = var.replica_logging_target_bucket != null ? 1 : 0

  bucket        = aws_s3_bucket.replication_bucket[count.index].id
  target_bucket = var.replica_logging_target_bucket
  target_prefix = var.replica_logging_target_prefix
}
...
resource "aws_iam_role" "bucket_replication" {
  ...
  name               = format("%s-%s-%s-%s", var.namespace, var.environment, var.name, var.bucket_replication_name_suffix)
...
resource "aws_iam_policy_attachment" "bucket_replication" {
  ...
  name       = format("%s-%s-%s-role-policy-attachment", var.namespace, var.environment, var.name)
